...
public class StepDefinitions {
    ...
    public void kullanici_sutunundaki_verileri_okur(String field) throws SQLException {
        ...
        System.out.println(resultSet.getString(field));//resultSet.next() nerede olursa olsun iterator'u bir sonraki
        ...
        // while lopp ile resultSet.next() false donunceye kadar gittik
        // dolayisiyla iterator sonda

        System.out.println(resultSet.getRow());
        resultSet.last();
        System.out.println(resultSet.getRow());

        // sianda tum price bilgileri resultSet uzerinde
        // eger bu bilgilerle birden fazla test yapacaksak
        // bu bulgileri Java ortaminda almakta fayda var
